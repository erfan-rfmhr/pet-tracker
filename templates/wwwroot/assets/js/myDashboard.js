...
$("#btnBuildingT").click(function () {
    ...
    $.ajax({
        type: "POST",
        async: true,
        url: "/dashboard?handler=GetLocation",
        ...
        success: function (response) {
            ...
            marker.bindPopup(_BuildingName).openPopup();

            $("#MapModalTitle").text(_BuildingName + " (" + m_lat + " , " + m_lng + ")");

            //$("#MapModalTitle").text("test" + " (" + m_lat + " , " + m_lng + ")");
    ...
    //data.Location  = "43.719400, -79.335755";
